from dtk.workflow import LeaveOneOutOptimizingWorkflow,LocalCode,GWASigStep,CodesStep

class gwasigCodesEvalFlow(LeaveOneOutOptimizingWorkflow):
    _fields = [
            'p2p_file',
            'p2p_min',
            'p2d_file',
    ...
    def __init__(self,**kwargs):
        super(gwasigCodesEvalFlow,self).__init__(**kwargs)
