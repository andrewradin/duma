...
# Author: iemam
###############################################################################
# edited by Aaron Daugherty on 2 Nov 2017, after downloading from here:
# https://raw.githubusercontent.com/Bioconductor-mirror/ArrayExpress/master/R/getAE.r
# only changed the baseURL issue, as described here:
# https://support.bioconductor.org/p/101049/
# I also added the library line, not mentioned explicitly in the above link
